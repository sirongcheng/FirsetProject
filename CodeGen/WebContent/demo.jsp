...
<body class="container">
	<h1>Twitter Bootstrap Typeahead Extension Demo</h1>
	v1.2.2
	<br /> Terry Rosen
	<br />
	<a href="https://github.com/tcrosen/twitter-bootstrap-typeahead"
		target="_blank">https://github.com/tcrosen/twitter-bootstrap-typeahead</a>
	<hr />
	<div class="alert alert-block alert-success"></div>
	<div class="row">
		<div class="well span4">
			<input id="demo1" type="text" class="span4"
...
<script type="text/javascript">
	...
	<div class="row">
		<div class="well span4">
			<input id="demo2" type="text" class="span4"
				placeholder="Search cities..." autocomplete="off" />
		</div>
		<pre class="prettyprint span7">
    $('#demo2').typeahead({
	...
	<div class="row">
		<div class="well span4">
			<input id="demo3" type="text" class="span4"
				placeholder="Search cities..." autocomplete="off" />
		</div>
		<pre class="prettyprint span7">
    $('#demo3').typeahead({
	...
	<div class="row">
		<div class="well span4">
			<input id="demo4" type="text" class="span4"
				placeholder="Search cities..." autocomplete="off" />
		</div>
		<pre class="prettyprint span7">
    $('#demo4').typeahead({
	...
	<div class="row">
		<div class="well span4">
			<input id="demo5" type="text" class="span4"
				placeholder="Search cities..." autocomplete="off" />
		</div>
		<pre class="prettyprint span7">
    $('#demo5').typeahead({
	...
	<h3 style="display:inline-block;">搜索:</h3><input id="test" type="text"/>
</body>
</html>
